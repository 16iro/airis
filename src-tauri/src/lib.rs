...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat_session::chat_sessions_list,
            commands::chat_session::chat_session_create,
            commands::chat_session::chat_session_rename,
            commands::chat_session::chat_session_delete,
            commands::chat_session::chat_session_delete_if_empty,
            ...
            commands::memory_facts::memory_facts_list,
            commands::memory_facts::memory_facts_recent,
            ...
            commands::srs::srs_generate_section,
            commands::srs::srs_generate_chunk,
            commands::srs::srs_generate_book,
            commands::srs::srs_generate_weak_priority,
